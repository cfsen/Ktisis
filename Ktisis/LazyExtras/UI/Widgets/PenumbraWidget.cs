...
class PenumbraWidget :ILazyWidget {
	...
	public PenumbraWidget(IEditorContext ctx) {
		this.Category = LazyWidgetCat.Misc; // TODO Set to API
	...
	public void Draw() {
		ImGui.BeginGroup();
		lui.DrawHeader(FontAwesomeIcon.Ad, "Penumbra API");
	...
	private void DrawUI() {
		ImGui.Text(ctx.Plugin.Ipc.IsPenumbraActive ? "Connected to Penumbra." : "Penumbra unavailable.");
	}
}
